...
| **6 — Tests & CI/CD** | 11–12 | Playwright test suite: auth ✅, habits ✅, goals ✅, checkins ✅, connectivity ✅ — playwright.config.ts: 120s timeout, webServer builds + starts production server in CI ✅ — .github/workflows/ci.yml: Node 20, Next.js build cache, Playwright chromium, 8 secrets, artifact upload on failure ✅ — .github/workflows/claude-pr-review.yml: Claude Code Action reviews TS, DB usage, RLS, tests, conventions ✅ — .github/workflows/trunk.yml + .trunk/trunk.yaml: eslint, prettier, checkov, trivy ✅ | Every push runs tests automatically. PRs get AI review. Broken builds are caught before merge. |
